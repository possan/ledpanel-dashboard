...
setInterval(function() {
 ...
 //     pixels[o] = (((x ^ y) % 16) == (fr % 16));
  ...
  for(var c=0; c<str.length; c++) {
    drawChar(str.substring(c, c+1), 5 + 4 * c + 3 * Math.sin(fr / 13.0 + c / 5.0 ), 3 + 3.0 * Math.sin(fr / 10.0 + c / 2.1));
  }
  ...
  drawString(str, 1, 11, 0);//(new Date()).toString().substring(16, 24), 12 + 12 * Math.sin(fr/40.0), 11, 0);
